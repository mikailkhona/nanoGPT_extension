...
def main(cfg):
    ...
    # path = '/home/bizon/temp-cot/Causal_graphs_chain_of_thought/aug25_motifs_set_20_motifs_mean_20/' 
    # motif_file_path = path + 'motif_set.pkl'
    #  with open(motif_file_path, "rb") as f:
        # motif_set =  pickle.load(f)
    # motif_token_dict = np.load(path + 'motif_set_token_dict.npz', allow_pickle=True)
    # token_map = motif_token_dict['token_map'].item()
